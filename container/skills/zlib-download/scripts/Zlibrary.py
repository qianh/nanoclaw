...
class Zlibrary:
    ...
    def __getBookFile(self, bookid: [int, str], hashid: str) -> [(str, bytes, str), None]:
        ...
        if res.status_code == 200:
            return filename, res.content, ddl

    def downloadBook(self, book: dict[str, str]) -> [(str, bytes, str), None]:
